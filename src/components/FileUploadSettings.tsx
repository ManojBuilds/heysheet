...
const FileUploadSettings = ({ form, onSave }: FileUploadSettingsProps) => {
  ...
  const planMaxFileSize = planLimits[subscription?.plan as keyof typeof planLimits || 'free'].maxFileSizeMB
  ...
  const [allowedTypes, setAllowedTypes] = useState<string[]>(form.file_upload_allowed_types ?? [])
  ...
  return (
    <Card className="relative overflow-hidden">
      <CardHeader>
        ...
        <CardDescription>
          Let users upload files in their submissions. Available only in paid plans.
        </CardDescription>
      </CardHeader>
